                    ...
                    <form action="/add-unit" method="POST">
                        <div class="p-3">
                            <div class="text-dark pb-4">
                                <label for="unit" class="pb-2">Nama unit</label>
                            ...
                            <div class="text-dark pb-4">
                                <label for="category" class="pb-2">Kategori</label>
                                <div class="input-group mb-3">
                                    <select id="category_select" name="category" class="form-control w-100">
                            ...
                            <div class="text-dark pb-4">
                                <label for="price" class="pb-2">Harga</label>
                            ...
                            <div class="text-dark pb-4">
                                <label for="select1" class="pb-2">Jenis</label>
                                <div class="input-group mb-3">
                                    <select id="select1" name="select1" class="form-control w-100">
                            ...
                            <div class="text-dark pb-4">
                                <label for="select2" class="pb-2">Kendali</label>
                                <div class="input-group mb-3">
                                    <select id="select2" name="select2" class="form-control w-100">
                                        <option value="option1">Option 1</option>
                                        <option value="option2">Option 2</option>
                                        <option value="option3">Option 3</option>
                                    </select>
                            ...
                            <div class="text-dark pb-4">
                                <label for="select3" class="pb-2">Gosaline</label>
                                <div class="input-group mb-3">
                                    <select id="select3" name="select3" class="form-control w-100">
                                        <option value="option1">Option 1</option>
                                        <option value="option2">Option 2</option>
                                        <option value="option3">Option 3</option>
                                    </select>
