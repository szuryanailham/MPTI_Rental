                ...
                <div class="row ">
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="unit" class="form-control" id="unit" placeholder="Unit"  value="{{ old('unit', request()->input('unit')) }}" disabled>
                      </div>
                      <div class="mb-3">
                        <label for="price" class="form-label">Harga Sewa</label>
                        <input type="number" name="price" class="form-control" id="price" placeholder="price"  value="{{ old('price', request()->input('price')) }}" disabled>
                      </div>
                </div>            
            <!-- PENYEWAAN END -->
            ...
            <div class="row ">
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="datetime-local" class="form-control" id="start-date" placeholder="Tanggal Sewa"  >
                  </div>
            </div>
            <!-- PENJEMPUTAN END  -->
            ...
            <div class="row ">
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="datetime-local" name="end-date" class="form-control" id="end-date" placeholder="Tanggal Pengembalian"  >
                  </div>
            </div>
            <!-- PENGEMBALIAN END  -->
