    ...
    <div class="row justify-content-center mt-4 m-3">
        <div class="col-sm-5 align-self-center d-flex me-5">
          ...
          <div class="col-12 col-md-5 pt-4">
            <h3 class="title" style="font-size: 40px; font-weight: 700; text-align: center;">TENTANG KAMI</h3>
          ...
          <div class="row justify-content-center text-center">
            ...
            <div class="col-10 d-flex justify-content-center profile-image">
              <div class="col-sm-4 g-2">
                <a href="https://www.instagram.com/cahaya_waskitha?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank">
                  <img src="assets/profile1.png" alt="Instagram">
                </a>
              </div>
              <div class="col-sm-4 g-2">
                <a href="" target="_blank">
                  <img src="assets/profile2.png" alt="Youtube">
                </a>
              </div>
              <div class="col-sm-4 g-2">
                <a href="https://wa.me/628562711129" target="_blank">
                  <img src="assets/profile3.png" alt="Whatsapp">
                </a>
              </div>
            </div>
